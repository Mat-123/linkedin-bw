import { FETCH_PROFILE, SAVE_PROFILE } from "../actions";

const initialState = {
  available: [], // qui dentro andranno a finire il profilo recuperati dalla fetch a
};

const fetchPersonalReduce = function (state = initialState, action) {
...
export default fetchPersonalReduce;
