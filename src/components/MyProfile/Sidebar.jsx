        ...
        <div className="sidebar-contact">
          <div className="d-flex ms-4">
            ...
            <div className="sidebar-text-profile text-start ms-2">
              ...
              <p className="sidebar-gray-text mb-0">Coordinatore Tax Credit</p>
          ...
          <div className="d-flex ms-4 mt-4">
            ...
            <div className="sidebar-text-profile text-start ms-2 ">
              ...
              <p className="sidebar-gray-text mb-0">Master’s Degree Student in </p>
          ...
          <div className="d-flex ms-4 mt-4">
            ...
            <div className="sidebar-text-profile text-start ms-2">
              ...
              <p className="sidebar-gray-text mb-0">Professore associato presso</p>
          ...
          <div className="d-flex ms-4 mt-4">
            ...
            <div className="sidebar-text-profile text-start ms-2">
              ...
              <p className="sidebar-gray-text">Hanno frequentato Università della Calabria</p>
              <Button className="sidebar-btn py-1">
                <svg
                  className="mb-1 me-1"
                  xmlns="http://www.w3.org/2000/svg"
