  ...
  return (
    <div className="sidebar">
      ...
      {params.utente ? (
        ...
        <div className="sidebar-first-section text-start border border-1 mb-2 whiteBck pb-2">
          <div className="pb-3  border-bottom">
            <div className="d-flex align-content-center gap-5">
              <h3 className="fs18">Lingua del profilo</h3>
            ...
            <p className="sidebar-gray-text fs14">Italiano</p>
          </div>
          <div className="mt-3">
            <div className="d-flex ">
              <h3 className="fs18">Profilo pubblico e URL</h3>
              <div className="pen-svg ms-auto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
            ...
            <p className="sidebar-gray-text fs14">www.linkedin.com/in/</p>
          </div>
        </div>
      )}

      {/* ----------SIDEBAR IMG----------- */}
      <div className="sidebar-img border border-1 mb-2">
        <img className="d-flex w-100 rounded" src={badge} alt="badge" />
      </div>

      {/* ------------SECOND SECTION------------- */}
      <div className="second-section border border-1 mb-2">
        <div className="sidebar-second-section text-start d-flex flex-column align-content-center   mt-2">
          <div className="mb-3">
            <h4 className="fs16">Persone che potresti conoscere</h4>
            <p className="sidebar-gray-text fs16">Dalla tua scuola o università</p>
          </div>
        ...
        <div className="sidebar-mostra-tutto d-flex justify-content-center align-items-center border-top  rounded-bottom  ">
          <p className="roboto-medium fs16 mt-2 p-1 ">Mostra tutto</p>
        </div>
      </div>
    </div>
  );
