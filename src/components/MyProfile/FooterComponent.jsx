          ...
          <Row>
            <Col xs={6} md={2}>
              <Nav className="flex-column">
                ...
                <NavLink className="titoloFooter">
                ...
                <NavLink>
                  <div className="d-flex align-items-start">
                    ...
                    <div className="d-flex flex-column">
                      <span className="titoloFooter">Domande?</span>
                      <span className="sottotitoloFooter">Visita il nostro Centro assistenza</span>
                    </div>
                  </div>
                </NavLink>
                <NavLink>
                  <div className="d-flex align-items-start">
                    ...
                    <div className="d-flex flex-column">
                      <span className="titoloFooter">Gestisci il tuo account e la tua privacy</span>
                      <span className="sottotitoloFooter">Vai alle impostazioni</span>
                    </div>
                  </div>
                </NavLink>
                <NavLink>
                  <div className="d-flex align-items-start">
                    ...
                    <div className="d-flex flex-column">
                      <span className="titoloFooter">Trasparenza sui contenuti consigliati</span>
                      <span className="sottotitoloFooter">Scopri di più sui contenuti consigliati.</span>
                    </div>
                  </div>
                </NavLink>
              </Nav>
