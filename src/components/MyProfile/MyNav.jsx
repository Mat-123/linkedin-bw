        ...
        <div className="navbar_div pt-1 d-flex">
          ...
          <div className="d-flex">
            <div className="nav_right d-flex">
              <div>
                <div className="home_icon iconPadding">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
              ...
              <div>
                <div className="network_icon iconPadding">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    data-supported-dps="24x24"
                ...
                <p className="textNav">Rete</p>
              </div>
              <div>
                <div className="jobs_icon iconPadding">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    data-supported-dps="24x24"
                ...
                <p className="textNav">Lavoro</p>
              </div>
              <div>
                <div className="messages_icon iconPadding">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    data-supported-dps="24x24"
                ...
                <p className="textNav">Messaggistica</p>
              </div>
              <div>
                <div className="notifications_icon iconPadding">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    data-supported-dps="24x24"
                ...
                <p className="textNav">Notifiche</p>
              </div>
              <div>
