...
const HeroComponent = () => {
  ...
  return (
    <Container fluid className="card position-relative pb-2 whiteBck mb-1">
      {
        params.utente ? <div>
      </div> : <div className="camera position-absolute">
        <img
          src={camera}
          alt=""
          style={{ height: "1em" }}
      ...
      <Container>
        <div className="d-flex my-4 my-4Personal">
          <div className="otherBorder position-absolute">
            <div className="profile">
              ...
              {
                params.utente ? <img src={otherProfile.image} alt="" className="imgProfile" /> : <img src={otherProfile.image} alt="" className="imgProfile" /> 
              }
        ...
        <div className="d-flex align-items-baseline">
         {
          params.utente ? <p className="fw-bold fs-3 nome">
          {otherProfile.name} {otherProfile.surname}
        </p> : <p className="fw-bold fs-3 nome">
        ...
        {
          params.utente ? <p className="blu fs-5 margin">{otherProfile.bio}</p> : <p className="blu fs-5 margin">{profile.bio}</p>
        }
        {/* <p className="blu fs-5 margin">{profile.bio}</p> */}
        <div className="left d-flex">
          {
            params.utente ? <p className="fs-5 d-inline">{otherProfile.area}&nbsp; </p> : <p className="fs-5 d-inline">{profile.area}&nbsp; </p>
          }
          ...
          {
            params.utente ? <p className="fs-5 d-inline blu fw-bold informazioni">
            &nbsp; {otherProfile.email}
          </p> : <p className="fs-5 d-inline blu fw-bold informazioni">
            &nbsp; {profile.email}
          </p>
          }
          {/* <p className="fs-5 d-inline blu fw-bold informazioni">
        ...
        <div className="text-start fs-5 mb-4">
          ...
          {
            params.utente ? <button className="me-2 btn-pr fw-bold btn-profileAlt1">
            {otherProfile.title}
          </button> : <button className="me-2 btn-pr fw-bold btn-profileAlt1">
            {profile.title}
          </button>
          }
